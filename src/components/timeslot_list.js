  ...
  return (
    <div className="timeslot-list col-xs-12 col-sm-6 nopadding-right">
      <div className="row nopadding">
        ...
        <h4 className="timeslot-list-header">{text('diacor_timeslot_list_header') + utils.formatDate2(props.pagelang, props.previousday)}</h4> :
        <h4 className="timeslot-list-header">{text('diacor_timeslot_list_header') + utils.formatDate2(props.pagelang, props.date_filter)}</h4>
        }
        {props.previousday == null ?
